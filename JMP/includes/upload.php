...
class  Media {
  ...
  public function upload($file)
  {
    ...
    elseif(!$this->file_ext($file['name'])):
      $this->errors[] = 'File not formatted correctly. ';
      return false;
    else:
 ...
 public function process(){
    ...
    elseif(!is_writable($this->productPath)):
      $this->errors[] = $this->productPath." Entry must be writable.";
      return false;
 ...
 /*--------------------------------------------------------------*/
  public function process_media(){
    ...
    if(!is_writable($this->productPath)){
        $this->errors[] = $this->productPath." Entr must be writable.";
        return false;
      }
 ...
 public function process_user($id){
    ...
    if(!is_writable($this->userPath)){
        $this->errors[] = $this->userPath." Entry must be writable.";
        return false;
      }
    if(!$id){
...
/*--------------------------------------------------------------*/
   public function media_destroy($id,$file_name){
     ...
     if(delete_by_id('media',$id)){
       ...
       $this->error[] = "Photo deletion failed or missing perms.";
       return false;
     }
